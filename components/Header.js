...
const Header = () => {
  return (
    <Head>
    <title>How Drip Works</title>
    <meta name="description" content="Get to know everything about the Drip Network and join the team with the highest reward system" />
